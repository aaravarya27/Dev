...
app.get("/filter", (req, res) => {
  ...
  type[0].toUpperCase(); //since req.query.type automatically takes all lower case input
...
app.put("/jokes/:id", (req, res) => {
  ...
  // alternatively 
  // const updatedJokeInd = jokes.findIndex((joke) => joke.id === id);
  // jokes[updatedJokeInd] = updatedJoke;
